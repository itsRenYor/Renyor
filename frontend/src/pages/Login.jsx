...
export default function Login() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      if (u.is_super_admin) nav("/admin");
      else nav(u.active_company_id ? "/app/dashboard" : "/onboarding");
    } catch (err) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-md">
        ...
        <Card className="p-8">
          ...
          <Button type="button" variant="outline" className="w-full mt-6 gap-2" onClick={startGoogleLogin} data-testid="login-google">
